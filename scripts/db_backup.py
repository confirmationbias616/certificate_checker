...
try:
    ...
    if (today_date - week_old_date).days > 7:
        shutil.move(
            "./db_backup/3_day/cert_db.sqlite3",
            f"./db_backup/week_old/cert_db_{today_date.date()}.sqlite3",
        )
...
try:
    shutil.move(
        "./db_backup/2_day/cert_db.sqlite3", "./db_backup/3_day/cert_db.sqlite3"
    )
...
try:
    shutil.move(
        "./db_backup/1_day/cert_db.sqlite3", "./db_backup/2_day/cert_db.sqlite3"
    )
